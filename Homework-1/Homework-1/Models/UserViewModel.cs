...
namespace Homework_1.Models
{
    public class UserViewModel
    {
        ...
        [RegularExpression("^(?=.*?[A-Z])(?=.*?[a-z])(?=.*?[0-9])(?=.*?[#?!@$%^&*-]).{8,}$", ErrorMessage = "Geçersiz Şifre! Şifreniz; en az bir küçük harf, bir büyük harf ve bir sayı dahil olmak üzere 8 karakterden oluşmalıdır.")]
